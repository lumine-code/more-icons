...
// constant is Seti's whole vertical/horizontal story under the icon contract:
// calibrated once against the octicon reference position, then frozen. The
// horizontal component exists because Seti's glyphs sit right-heavy in their
// advance and eat into the gap before the file name.
const NUDGE = { x: 0, y: 0 };
